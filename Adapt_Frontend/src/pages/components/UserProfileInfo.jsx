  ...
  return (
    <div className="relative py-4 px-6 md:px-8 bg-white">
      <div className="flex flex-col md:flex-row items-start gap-6">
        ...
        {/* Imagem de perfil com posicionamento absoluto */}
        <div className="w-32 h-32 border-4 border-white shadow-lg absolute -top-16 left-6 rounded-full overflow-hidden z-10">
          <img
        ...
        {/* Informações do usuário com padding-top para evitar sobreposição */}
        <div className="w-full pt-36 md:pt-0 md:pl-36">
          ...
          <div className='flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4'>
            ...
            <span className='flex items-center gap-1.5'>
                ...
                Joined <span className='font-medium'>{moment(user.createdAt || user.createAt).fromNow()}</span>
            </span>
          </div>
