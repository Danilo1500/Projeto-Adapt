...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      {/*left side : branding*/}
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 gap-40">
        ...
        <div>
          ...
          <h1 className="text-3xl md:text-6xl md:py-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent">
            More than just friends truly connect</h1>
            <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md">
              Connect with global community on Adapt</p>
        </div>
